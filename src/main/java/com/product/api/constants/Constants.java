package com.product.api.constants;

public class Constants {
	
	public static String URI = "http://redsky.target.com/v2/pdp/tcin/";
	public static String TAXONOMY ="taxonomy";
	public static String PRICE ="price";
	public static String PROMOTION ="promotion";
	public static String BULKSHIP ="bulk_ship";
	public static String RATING_AND_REVIEWS ="rating_and_review_reviews";
